...
public class PullMessageRequestHeader implements CommandCustomHeader {
    ...
    /**
     * @description: 系统标识：第0位-flag_commit_offset-标记消费进度位置
     *                       第1位-flag_suspend-标记请求是否被挂起（有一个最大挂起时间设置）
     *                       第2位-flag_suscription-标记是否过滤订阅表达式（配合过滤表达式使用）
     * @param:
     * @return:
     */
    @CFNotNull
    ...
    /**
     * 这个参数的是『长轮询时间的核心参数』：他决定了Broker 端 HOLD 住客户端过来的时间长度。如果这个时间段内一直没有消息，时间到后就返回null回去
     *
