...
public class SendMessageRequestHeader implements CommandCustomHeader {
    ...
    @CFNotNull
    private Integer queueId; // 队列ID(队列序号)
    @CFNotNull
    private Integer sysFlag; // 消息系统标记(MessageSysFlag)
    @CFNotNull
    private Long bornTimestamp; // 消息发送时间
    @CFNotNull
    private Integer flag; // 消息标记(RocketMQ对消息中的flag不做任何处理，供应用程序使用)
    @CFNullable
    ...
    @CFNullable
    private boolean batch = false; // 是否是批量消息
