...
public class MQClientAPIImpl {
    ...
    /**
     * @description: 无论何种模式的消息发送都会走到这个方法
     * @param:
     * @return:
     */
    public SendResult sendMessage(
    ...
    public PullResult pullMessage(
        ...
        /*
         * 会根据这个RequestCode很容易找到Brokder端处理消息拉取的入口:
    ...
    /**
     * 使用给定的topic主题到NameServer中查询Topic路由信息
     */
    ...
    /**
     * @description: 到NameServer中去请求主题路由信息
     * @param:
     * @return: TopicRouteData：topic主题路由信息
     */
