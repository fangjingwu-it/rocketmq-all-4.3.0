...
public class PullAPIWrapper {
    ...
    /**
     * 消息队列 与 拉取Broker 的映射, 当拉取消息时，会通过该映射获取拉取请求对应的Broker
     */
    ...
    public PullResult pullKernelImpl(
        ...
        // 根据 brokerName、 BrokerId从 MQClientlnstance 中获取 Broker地址
        ...
        if (findBrokerResult != null) {
            ...
            // 设置Broker最长阻塞时间，默认设置是15秒，注 意是 Broker在没有新消息的时候才阻塞，有消息会立刻返回
            ...
            /*
             * 如果消息过滤模式为类过滤， 则需要根据主题名称、 broker地址找到注册在
             * Broker上的 FilterServer地址，从 FilterServer上拉取消息，否则从 Broker上拉取消息
             */
    ...
    /**
     * @description: 计算消息队列拉取消息对应的Broker编号
     * @param: mq 消息队列
     * @param:
     * @return: Broker ID
     */
