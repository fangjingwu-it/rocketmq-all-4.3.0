...
/**
 * RocketMQ提供了管理接口MQAdmin来支持用户的后台管理需求，比如topic创建，消息查询等
 */
public class MQAdminImpl {
    ...
    public void createTopic(String key, String newTopic, int queueNum, int topicSysFlag) throws MQClientException {
        try {
            ...
            // //一般使用defaultTopic获取已经存在的broker data，所有的broker默认都支持defaultTopic
            ...
            if (brokerDataList != null && !brokerDataList.isEmpty()) {
                ...
                // 轮询所有broker，在master机器上创建topic，中间有一个broker失败，则中止创建
    ...
    /**
     * @description: 获取该主题下所有MessageQueue的内容
     * @param:
     * @return:
     */
    public Set<MessageQueue> fetchSubscribeMessageQueues(String topic) throws MQClientException {
        try {
            // 使用消费端的客户端实例，获取主题路由信息
            TopicRouteData topicRouteData = this.mQClientFactory.getMQClientAPIImpl().getTopicRouteInfoFromNameServer(topic, timeoutMillis);
            if (topicRouteData != null) {
