...
public class KVConfigManager {
    ...
    private final HashMap<String/*Namespace：对应的是那台机器的配置文件 */,
            HashMap<String/*具体配置文件的Key*/, String/*具体配置文件的value*/>> configTable = new HashMap<String, HashMap<String, String>>();
    ...
    public void putKVConfig(final String namespace, final String key, final String value) {
        try {
            ...
            // 因为操作的configTable是一个非线程安全的HashMap，所以这里使用率写锁
